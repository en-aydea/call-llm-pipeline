# call-llm-pipeline
A LangChain-based framework for automated analysis of banking call transcripts with LLM-driven summarization, topic classification, and structured insight extraction.
